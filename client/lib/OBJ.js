...
THREE.OBJLoader.prototype = {
	...
	load: function ( obj, onLoad, parameters ) {//onProgress, onError

		var scope = this;

		var loader = new THREE.XHRLoader( scope.manager );
		loader.setCrossOrigin( this.crossOrigin );
		loader.load( 'obj/'+obj+'.obj', function ( text ) {

			onLoad( scope.parse( text, obj ) );
	...
	parse: function ( text, obj ) {
		...
		for ( var i = 0, l = objects.length; i < l; i ++ ) {
			...
			if ( geometry.uvs.length > 0 ) {
				...
				buffergeometry.addAttribute( 'uv2', new THREE.BufferAttribute( new Float32Array( geometry.uvs ), 2 ) );
